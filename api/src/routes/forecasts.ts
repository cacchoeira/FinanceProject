...
function generateSeasonalForecast(transactions: any[], timeHorizon: number) {
...
function calculateSeasonalFactors(monthlyData: any[]) {
  // Calculate seasonal adjustment factors
  return {};
}

function runMonteCarloSimulation(transactions: any[], timeHorizon: number) {
